...
module.exports = {
  ...
  execute: async (client, message, args) => {
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .addField(`🗓 Creation Date -`, `16th Desember 2021`, false)
      .addField(`Made With :`, `Node.js V12 And SQ Lite DataBase And Your Love :v`, false)
      .addField(`:tools: Developers of This Bot -`, `FTH PLAYZ`, false)
